...
# bot
bot_token = os.environ.get("TOKEN", "6691213151:AAE38Dqsld7gRXB_LthvpMMMskfuLZgVfV4")
api_hash = os.environ.get("HASH", "af7b9b8a0d377b4d3735199e9df008af") 
api_id = os.environ.get("ID", "2071434027")
